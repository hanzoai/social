  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_social',
              'Am I going to be charged by Hanzo Social?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_social_will_hold',
              'To confirm credit card information Hanzo Social will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        'faq_can_i_trust_social_social',
        `Can I trust ${isGeneral ? 'Hanzo Social' : 'Hanzo Social'}?`
      ),
      description: t(
        'faq_social_social_is_proudly_open_source',
        `${
          isGeneral ? 'Hanzo Social' : 'Hanzo Social'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'Hanzo Social' : 'Hanzo Social'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/hanzoai/social" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_social_social_allows_you_to_schedule_posts',
        `${
          isGeneral ? 'Hanzo Social' : 'Hanzo Social'
