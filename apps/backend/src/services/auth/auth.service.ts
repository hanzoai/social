...
import { AuthService as AuthChecker } from '@social/helpers/auth/auth.service';
...
import { NewsletterService } from '@social/nestjs-libraries/newsletter/newsletter.service';
