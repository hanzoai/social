...
# Copilot Coding Agent Instructions for Hanzo Social
...
- SDK (`apps/sdk`) provides programmatic access to Hanzo Social features.
...
## Documentation
- Main docs: https://docs.social.com/
- Developer guide: https://docs.social.com/developer-guide
- Public API: https://docs.social.com/public-api
