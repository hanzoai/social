import { RedditSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/reddit.dto';
import { PinterestSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/pinterest.dto';
import { YoutubeSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/youtube.settings.dto';
import { TikTokDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/tiktok.dto';
import { XDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/x.dto';
import { LemmySettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/lemmy.dto';
...
import { KickDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/kick.dto';
import { TwitchDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/twitch.dto';
import { InstagramDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/instagram.dto';
import { LinkedinDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/linkedin.dto';
import { IsIn } from 'class-validator';
import { MediumSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/medium.settings.dto';
import { DevToSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/dev.to.settings.dto';
import { HashnodeSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/hashnode.settings.dto';
import { WordpressDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/wordpress.dto';
import { ListmonkDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/listmonk.dto';
import { GmbSettingsDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/gmb.settings.dto';
import { FarcasterDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/farcaster.dto';
...
import { WhopDto } from '@social/nestjs-libraries/dtos/posts/providers-settings/whop.dto';
